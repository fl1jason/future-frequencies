  ...
  useEffect(() => {
    ...
    const animate = (t: number) => {
      ...
      if (p) {
        ...
        uniforms.uTime.value = (t * 0.001 * p.speed) || 0;
        uniforms.uAttenuation.value = p.attenuation || 0;
        uniforms.uColor.value.set(p.color || '#fc42ff');
        uniforms.uColorTwo.value.set(p.colorTwo || '#42fcff');
        uniforms.uLineThickness.value = p.lineThickness || 0;
        uniforms.uBaseRadius.value = p.baseRadius || 0;
        uniforms.uRadiusStep.value = p.radiusStep || 0;
        uniforms.uScaleRate.value = p.scaleRate || 0;
        uniforms.uRingCount.value = p.ringCount || 0;
        uniforms.uOpacity.value = p.opacity || 1;
        uniforms.uNoiseAmount.value = p.noiseAmount || 0;
        uniforms.uRotation.value = ((p.rotation || 0) * Math.PI) / 180;
        uniforms.uRingGap.value = p.ringGap || 1.6;
        uniforms.uFadeIn.value = p.fadeIn || 0.5;
        uniforms.uFadeOut.value = p.fadeOut || 0.75;
        uniforms.uMouse.value.set(smoothMouseRef.current[0], smoothMouseRef.current[1]);
        uniforms.uMouseInfluence.value = p.followMouse ? p.mouseInfluence || 0 : 0;
        uniforms.uHoverAmount.value = hoverAmountRef.current;
        uniforms.uHoverScale.value = p.hoverScale || 1;
        uniforms.uParallax.value = p.parallax || 0;
